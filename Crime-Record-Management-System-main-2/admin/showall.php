...
include("navbar.php");
?>
<h1 class="text-center text-white bg-dark m-3">All Data:</h1>
    <br>
  ...
  <?php
                $sql="select c.caseid,c.crimetype,c.dateofcrime,c.section,c.description,cc.criminalid,cc.fname,cc.lname,cc.gender,cc.age,cc.image,p.punishment from crime c,criminal cc,punishment p where c.caseid=cc.caseid and cc.criminalid=p.criminalid";
